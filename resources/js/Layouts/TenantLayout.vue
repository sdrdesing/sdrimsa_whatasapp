...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav style="background: #073f68;" class="border-b border-transparent">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink v-for="link in links" :key="link.name" :href="link.url" :active="link.active" class="text-white">
                                    {{ link.name }}
                                </NavLink>
                            </div>
                        </div>
                        ...
                        <div class="-me-2 flex items-center sm:hidden">
                            <button @click="showingNavigationDropdown = !showingNavigationDropdown"
                                class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-gray-200 hover:bg-transparent focus:outline-none focus:bg-transparent focus:text-gray-200 transition duration-150 ease-in-out">
